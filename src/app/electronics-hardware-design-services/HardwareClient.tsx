    ...
    <>
      ...
      <section className="sec bg-s" id="hardware-case-studies">
        <div className="sec-in">
          ...
          <div className="g4">
            {[
              { badge: 'Medical Devices', badgeCls: 'rd', title: 'Smart Wearable for Elder Fall Detection', problem: 'Elderly falls often go undetected, causing delayed emergency response and serious health risks.', solution: 'Designed a BLE-enabled wearable with accelerometer, SOS button, and real-time fall detection algorithm.', result: '95%+ detection accuracy', timeline: 'Delivered in 4–6 months', tags: ['BLE', 'Accelerometer', 'IoT'], img: '/images/case-studies/smart-wearable-fall-detection.png', alt: 'Medical wearable fall detection hardware device by Knowx Innovations' },
              { badge: 'EV & Renewable', badgeCls: 'tl', title: 'Smart Meter for EV Charging Stations', problem: 'Lack of accurate, connected energy metering for EV charging infrastructure.', solution: 'Built a smart energy meter with ARM MCU, IoT connectivity, and real-time billing integration.', result: '±1% accuracy, 30% cost reduction', timeline: 'Delivered in 5–7 months', tags: ['ARM MCU', 'IoT', 'Power Electronics'], img: '/images/case-studies/ev-charging-smart-meter.png', alt: 'EV charging smart meter PCB design and hardware by Knowx Innovations' },
              { badge: 'Industrial Automation', badgeCls: 'gn', title: 'Smart Windows for Large Godowns', problem: 'Poor ventilation and high energy costs in large storage facilities.', solution: 'Developed sensor-based automated window control with wireless connectivity and environmental monitoring.', result: '25–35% energy savings', timeline: 'Delivered in 4–6 months', tags: ['Sensors', 'Wireless', 'Automation'], img: '/images/case-studies/smart-window-warehouse.png', alt: 'Industrial automation smart window control hardware by Knowx Innovations' },
              { badge: 'Industrial Automation', badgeCls: 'bl', title: 'BLE-Based Asset Tracking for Warehouses', problem: 'Inefficient tracking leading to misplaced assets and operational delays.', solution: 'Created low-power BLE tracking devices with gateway and cloud integration for real-time asset visibility.', result: '90%+ asset visibility', timeline: 'Delivered in 3–5 months', tags: ['BLE', 'Low Power', 'Cloud'], img: '/images/case-studies/ble-asset-tracking-device.png', alt: 'BLE asset tracking warehouse hardware device by Knowx Innovations' },
            ].map((cs, i) => (
