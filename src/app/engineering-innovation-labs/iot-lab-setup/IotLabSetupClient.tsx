...
const s5Kits: { title: string; badge: string; idealFor: string; capabilities: string[]; tint: KitTint; imgAlt: string; imgGradient: string; href: string }[] = [
  { title: "IoT Starter Kit", badge: "Beginner", idealFor: "First-year students & IoT fundamentals courses", capabilities: ["30+ structured experiments", "10 guided mini projects", "ESP32 Wi-Fi + Bluetooth", "Plug-and-play sensor modules", "Step-by-step experiment guides", "Mobile app integration basics"], tint: "green", imgAlt: "IoT Starter Kit for engineering students — Knowx India", imgGradient: "linear-gradient(135deg,#0f766e 0%,#0d9488 100%)", href: "/engineering-innovation-labs/iot-kits#iot-starter-kit" },
  { title: "ESP32 Professional IoT Kit", badge: "Intermediate", idealFor: "ECE / CSE 2nd & 3rd year IoT & embedded courses", capabilities: ["60+ experiments across domains", "25 industry-grade IoT projects", "40+ sensor & actuator modules", "Cloud IoT — AWS · Azure · GCP", "MQTT · HTTP · REST protocols", "Mobile dashboard development"], tint: "blue", imgAlt: "ESP32 Professional IoT Kit — Knowx India", imgGradient: "linear-gradient(135deg,#1e3a8a 0%,#2d5cc8 100%)", href: "/engineering-innovation-labs/iot-kits#esp32-professional-iot-kit" },
  { title: "Industrial IoT Kit", badge: "Advanced", idealFor: "Final-year projects, Industry 4.0 & Industrial IoT labs", capabilities: ["80+ industrial experiments", "30 Industry 4.0 projects", "ESP32 + STM32 + Raspberry Pi", "SCADA & PLC integration", "Predictive maintenance demos", "Smart factory scenario kits"], tint: "amber", imgAlt: "Industrial IoT Kit for engineering colleges — Knowx India", imgGradient: "linear-gradient(135deg,#b45309 0%,#d97706 100%)", href: "/engineering-innovation-labs/iot-kits#industrial-iot-kit" },
  { title: "Raspberry Pi Edge AI Kit", badge: "AI + IoT", idealFor: "AI & IoT programs, Edge computing & Vision labs", capabilities: ["Linux & Python environment", "AI / ML model deployment", "Computer vision with OpenCV", "Edge AI inference (TFLite)", "IoT gateway implementation", "Cloud + edge hybrid setup"], tint: "teal", imgAlt: "Raspberry Pi Edge AI Kit — Knowx India", imgGradient: "linear-gradient(135deg,#0d9488 0%,#0f766e 100%)", href: "/engineering-innovation-labs/iot-kits#edge-ai-computer-vision-kit" },
  { title: "STM32 Embedded Systems Kit", badge: "Embedded", idealFor: "Embedded systems, RTOS & industrial protocol labs", capabilities: ["Embedded C & firmware dev", "RTOS — FreeRTOS / Zephyr", "Industrial protocols (Modbus, CAN)", "Real-time system design", "Automotive & industrial use cases", "Hardware debugging & profiling"], tint: "green", imgAlt: "STM32 Embedded Systems Kit — Knowx India", imgGradient: "linear-gradient(135deg,#0f766e 0%,#1e3a8a 100%)", href: "/engineering-innovation-labs/iot-kits#stm32-embedded-systems-kit" },
  { title: "Smart Factory Learning Platform", badge: "Industry 4.0", idealFor: "Innovation centres, CoEs & smart manufacturing labs", capabilities: ["Smart manufacturing simulation", "Digital factory modelling", "Machine vision integration", "AI predictive maintenance", "OPC-UA & Industry 4.0 stack", "Complete IIoT ecosystem demo"], tint: "blue", imgAlt: "Smart Factory Learning Platform — Knowx India", imgGradient: "linear-gradient(135deg,#1e3a8a 0%,#0d9488 100%)", href: "/engineering-innovation-labs/iot-kits#smart-factory-learning-platform" },
];
